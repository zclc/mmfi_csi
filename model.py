...
class ResNet(nn.Module):
    def __init__(self,
        ...
        self.conv1 = nn.Conv2d(1, self.in_channel, kernel_size=3, stride=1,
        ...
        self.layerB = nn.Conv2d(512, 3, 1, 1)  # output [3, 17, 17]
        self.avgpool2 = nn.AvgPool2d(kernel_size=(1, 17), ceil_mode=True)
